...
- Supports 3 AI providers: Ollama (local), OpenAI, Hugging Face
- Automatic fallback to default responses if AI unavailable
- Smart prompt generation for normal vs. crisis situations
...
```
AI_PROVIDER         Options: ollama, openai, huggingface (default: ollama)
