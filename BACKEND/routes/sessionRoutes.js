...
// Deletes a session and all its associated chat history permanently
router.delete('/:sessionId', checkSupabase, authMiddleware, async (req, res) => {
  try {
    const userId = req.userId;
    const { sessionId } = req.params;
    ...
    // Supabase cascade delete (if configured) or manual delete
