...
class TranscriptionService {
     ...
     */
    static async transcribe(audioFile, frontendLanguage = null) {
        ...
        let mappedLang = null;
        if (frontendLanguage) {
            mappedLang = frontendLanguage.split('-')[0]; // e.g. ml-IN -> ml
        }
        const STT_LANGUAGE = process.env.STT_LANGUAGE || mappedLang;
