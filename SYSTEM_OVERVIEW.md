...
│  │ ✓ 7 Emotion Types             ✓ Confidence Scoring  │ │
...
│  │          RESPONSE SERVICE                             │ │
│  ├───────────────────────────────────────────────────────┤ │
│  │ ✓ 7 Emotion Types             ✓ Suggestions         │ │
│  │ ✓ Empathetic Messaging        ✓ Follow-up Questions │ │
│  │ ✓ Contextual Responses        ✓ Response Validation │ │
│  │ ✓ Natural Conversations       ✓ Quality Assurance   │ │
│  └───────────────────────────────────────────────────────┘ │
│                                                             │
│  ┌───────────────────────────────────────────────────────┐ │
...
😐 Neutral            EXPLORATION             • Open curiosity
...
│     └─ Type: Online resources & screening
│
└─ MODERATE Level
...
ELSE:
   ...
   RETURN normal_response_package()
```
